...
| --- | --- | ---: | ---: | ---: |
| `gpt-5.6-luna`, `reasoning: none` | 4/4 passed | 2,445 | 232 | 8,234 ms |
| `gpt-5.6-luna`, `reasoning: low` | Failed receipt budget-treatment assertion after 3 passing cases | Not recorded after failure | Not recorded after failure | Not recorded after failure |
...
This four-case set is a release gate, not proof of universal receipt accuracy. Add representative cases whenever a new AI behavior, language, currency, image type, or known failure mode is introduced.
